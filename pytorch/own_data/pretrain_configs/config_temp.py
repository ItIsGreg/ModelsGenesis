...
class models_genesis_config:
    ...
    originals_train = os.path.join(originals, 'train')
    originals_val = os.path.join(originals, 'val')
    segmentations_train = os.path.join(segmentations, 'train')
    segmentations_val = os.path.join(segmentations, 'val')
